...
@section('header-title', 'Nuevo Riesgo - Sistema SGSST')
                ...
                <div class="mb-3">
                    <div class="form-group">
                        ...
                        <select name="otros_factores" id="otros_factores" class="form-select">
                            <option value="No aplica" {{ old('otros_factores', 'No aplica') == 'No aplica' ? 'selected' : '' }}>No aplica</option>
                            <option value="Factores sociales" {{ old('otros_factores') == 'Factores sociales' ? 'selected' : '' }}>Factores sociales</option>
                            <option value="Carga de trabajo" {{ old('otros_factores') == 'Carga de trabajo' ? 'selected' : '' }}>Carga de trabajo</option>
                            <option value="Horas de trabajo" {{ old('otros_factores') == 'Horas de trabajo' ? 'selected' : '' }}>Horas de trabajo</option>
                            <option value="Victimización y acoso e intimidación" {{ old('otros_factores') == 'Victimización y acoso e intimidación' ? 'selected' : '' }}>Victimización y acoso e intimidación</option>
                            <option value="Inmediaciones del lugar de trabajo" {{ old('otros_factores') == 'Inmediaciones del lugar de trabajo' ? 'selected' : '' }}>Inmediaciones del lugar de trabajo</option>
                            <option value="Situaciones no controladas por la organización y que ocurren en las inmediaciones" {{ old('otros_factores') == 'Situaciones no controladas por la organización y que ocurren en las inmediaciones' ? 'selected' : '' }}>Situaciones no controladas por la organización y que ocurren en las inmediaciones</option>
                        </select>
